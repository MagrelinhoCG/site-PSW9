...
def deletar_flashcard(request, id):
    # Fazer a validação de segurança usando request.user
...
def iniciar_desafio(request):
    if request.method == "GET":
        ...
        dificuldade= request.POST.get('dificuldade')   # getlist porque ele é tipo multiple, ou seja ele envia uma lista de dados
        ...
        desafio.save()
        #desafio.categoria.add(*categorias) também funciona
